  ...
  const renderCard = (content: MarketingContent) => {
    ...
    switch (content.type) {
      ...
      case 'promotional':
        return (
          <div className={commonCardClasses}>
            <div className="relative h-48 rounded-t-[20px] overflow-hidden group">
...
<iframe
            ...
            ) : selectedContent.type === 'promotional' ? (
              <div className="relative w-full h-[80vh]">
                <Image
                  src={`https://admin.lucrumindustries.com/public/uploads/${selectedContent.file_path.replace(/^https?:\/\/[^/]+\/public\/uploads\//i, '')}`}
